...
#+INDEX: Zen do Gabriel de Desenvolvimento Tecnológico
#+DATE: <2024-09-21 20:44:01>
#+LANGUAGE: pt

Tradução do [[/posts/zen.html][original]].
...
1. Os únicos programadores que devem se importar com datilografia veloz são aqueles que competem, programam em Java ou ganham mais por programarem mais linhas de Código.

2. Porém, caso você seja um dos últimos dois, pode querer repensar suas Escolhas de Vida.

3. Geralmente, há Algo errado caso Programação não traga Alegria.

4. E deve ser notado que Algo pode estar errado fora do Código.

5. Você deve entender o que certo Pedaço de Código está fazendo, mesmo que ele esteja fazendo errado.

6. E caso um Pedaço de Código esteja fazendo Algo certo e você não entende como, o Código está errado de qualquer forma.

7. Logo, entender o que o Código faz é a Coisa mais importante em Programação.

8. Ao Programar, nenhum Problema é resolvido no Editor de Texto.

9. Eles são resolvidos no Papel, com uma Caneta ou Lápis.

10. Logo, é importante saber quando deixar o Computador e pegar o Papel.

11. Programação de Computadores não é uma Arte manual. É uma Intelectual. Trate-a de acordo.

12. Programação de Computadores também é parte da Matemática. Ainda que algumas Pessoas possam ter raiva dessa Afirmação.

13. Você não precisa saber o funcionamento interno de Algo, exceto quando você precisa.

14. Você nunca é mais esperto que Compiladores, Bibliotecas, Frameworks ou qualquer outro Código escrito antes de você, exceto quando você é.

15. E você se surpreenderia se soubesse quantas vezes você é mais perspicaz do que pensa.

16. Inclusive porque Informação específica a um Contexto é muito Poderosa.

17. Programar um Computador é mais sobre Ler que Escrever. É melhor gastar 2 horas lendo Cormen ou Knuth e 1 hora Programando Algo do que as mesmas 3 horas apenas Programando o exato mesmo Algo.

18. Porém os autores devem ser escolhidos cuidadosamente, e não devem incluir Robert Cecil Martin.

19. Nenhuma das Afirmações acima farão algo caso você não vá Programar Algo.

** Apêndice C: Programação na Linguagem de Programação C
1. Se você tem alguma Ideia, por menor que seja, de como implementar um Pedaço de Código específico em Assembly, esse Pedaço de Código provavelmente é uma boa ideia.

2. Ainda que o Compilador possa gerar Algo completamente diferente.

3. O Compilador não deve ser combatido, já que ele é um Amigo.

4. =$ find . -name "*.[c,h]" -exec clang-format -i {} \;=.

5. C não é uma Linguagem de Programação Fortemente tipada.

8. Mas é uma Estática, e isso deve ser aproveitado.

7. =-ansi -pedantic= cria Caráter.

8. Memória é a Coisa mais importante sempre. Mais que o seu cônjuge.

9. Se você não consegue ter certeza de quantas vezes um =malloc()= será chamado em um Lugar específico, esse Lugar não deve ter uma chamada para =malloc()=.

10. A Pilha é uma Amiga. Use-a sabiamente.

11. "The C Programming Language" é nossa Bíblia. K&R são nossos Profetas. C não é Ciência, mas Religião.

12. Logo, entendê-la é um Processo Religioso.

13. Use o Depurador quando em dúvida e quando não.

14. Não tenha medo de fazer Algo na mão ou utilizar uma Técnica Proibida, exceto que seu Professor vá te dar uma nota pior por isso.

15. Aprenda antes de digitar e entenda antes de compilar.

16. Se lidando com Problemas de Memória, =goto C;=.

17. Ninguém gosta de Programar em C. Objetivamos matá-la em breve.

18. Ainda que ainda Programemos em C, e nossos Ambientes ainda dependam dela.

19. C está morta. Vida longa a C!
